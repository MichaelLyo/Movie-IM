...
function Table(id,type) {
    ...
    if (id === 'name') {
        ...
        if (mvNametb === null) {
            ...
            $.ajax({
                url: '/movie/ajax/showmovieName?searchStr='+moviename,
                dataSrc: '',
                success: function (data) {
    ...
    if (id === 'director') {
        ...
        if (mvDirectortb === null) {
            ...
            $.ajax({
                url: '/movie/ajax/showdirector?searchStr='+direcorName,
                dataSrc: '',
                success: function (data) {
                    var dataSrc;
                    dataSrc = data[0];
    ...
    if (id === 'actor') {
        ...
        if (mvActortb === null) {
            ...
            $.ajax({
                url: '/movie/ajax/showactor?searchStr='+actorName,
                dataSrc: '',
                success: function (data) {
    ...
    if (id === 'category') {
        ...
        if (mvTypetb === null) {
            ...
            $.ajax({
                url: '/movie/ajax/showcategory?searchStr='+typename,
                dataSrc: '',
                success: function (data) {
                    dataSrc = data[0];
    ...
    if (id === 'language') {
        ...
        if (mvLanguagetb === null) {
            ...
            $.ajax({
                url: '/movie/ajax/showlanguage?searchStr='+languagename,
                dataSrc: '',
                success: function (data) {
